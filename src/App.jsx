...
const API = {
  userByEmail: (email) => `/wavuser/api/WAVInternalUser/byEmail/${encodeURIComponent(email)}`,
  createPatient:  `/patient/api/Patient/create`,
  createOrder:    `/patient/api/Order`,
  uploadOrderPdf: (orderId) => `/admin/api/OrderPdfUpload/upload/${orderId}`,
};
